...
class Test extends Component{
    ...
    getMaze = async (e) => {
        const mazeResponse = await fetch(`https://reedmazebackend.herokuapp.com/maze/maze/test/${this.props.match.params.testId}`)
    ...
    youLost = async () => {
        const loser = await fetch(`https://reedmazebackend.herokuapp.com/maze/maze/test/loser/${this.props.match.params.testId}`, {
            method: 'PUT',
            credentials: 'include',
            headers:{
    ...
    submitMaze = async (e) => {
        e.preventDefault();
        const winner = await fetch(`https://reedmazebackend.herokuapp.com/maze/maze/test/${this.props.match.params.testId}`, {
            method: 'PUT',
            credentials: 'include',
            headers:{
                "Content-type" : 'application/json'
